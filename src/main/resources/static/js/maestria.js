        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                  ...
                  var actionsHtml = '<a href="#" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#confirmarEliminar-' + row.id + '">';
                  ...
                  actionsHtml += '<a type="button" class="btn btn-outline-secondary" href="#">';
